...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    public void onResume() {
        super.onResume();
        atualizadorDeLeiloes.buscaLeiloes(adapter, client, new AtualizadorDeLeiloes.ErroCarregaLeiloesListen() {
            @Override
            public void errorAoCarregar(String mesg) {
                mostraMensagemFalha();
            }
        });
    }
    ...
    public void mostraMensagemFalha() {
        Toast.makeText(this,
